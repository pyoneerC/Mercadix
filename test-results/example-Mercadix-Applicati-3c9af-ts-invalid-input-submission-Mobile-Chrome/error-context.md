...
- Number of pages must be between 1 and 3
+
+
+
+
...
+     
+         
+             Escribí el nombre de un producto y
+             
+                 Mercadix te muestra en segundos
+             
...
+     
+         
+             © 2024 PyoneerC — No afiliado a Mercado Libre.
+             
+                 
+                     GitHub
+                 
...
Call log:
  ...
  - waiting for locator('body')
    6 × locator resolved to <body class="bg-gray-100 flex items-center justify-center min-h-screen">…</body>
      - unexpected value "
...
"
    ...
    at /workspaces/Mercadix/tests/e2e/example.spec.js:83:40
```
...
- textbox "Artículo a buscar:": iphone
- text: "Cantidad de páginas a escanear:"
- spinbutton "Cantidad de páginas a escanear:": "5"
