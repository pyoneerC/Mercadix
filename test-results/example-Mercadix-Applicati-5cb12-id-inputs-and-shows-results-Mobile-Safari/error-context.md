...
- Name: Mercadix Application End-to-End Tests >> form submits with valid inputs and shows results
- Location: /workspaces/Mercadix/tests/e2e/example.spec.js:19:3
